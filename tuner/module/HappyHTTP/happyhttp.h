...
typedef std::function<void(const happyhttp::Response* r, void* userdata)> ResponseBegin_CB;
typedef std::function<void(const happyhttp::Response* r, void* userdata, const unsigned char* data, int numbytes)> ResponseData_CB;
typedef std::function<void(const happyhttp::Response* r, void* userdata)> ResponseComplete_CB;
